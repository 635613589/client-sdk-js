...
function getEmptyVideoStreamTrack() {
  ...
  if (!emptyVideoStreamTrack) {
    ...
    canvas.width = 16;
    canvas.height = 16;
    (_a = canvas.getContext('2d')) === null || _a === void 0 ? void 0 : _a.fillRect(0, 0, canvas.width, canvas.height);
    // @ts-ignore
...
class LocalVideoTrack extends LocalTrack {
  ...
  async handleAppVisibilityChanged() {
    ...
    if (this.source === Track.Source.Camera) {
      this._mediaStreamTrack.enabled = !this.isInBackground;
    }
  }
}
...
function computeVideoEncodings(isScreenShare, width, height, options) {
  ...
  if (isScreenShare) {
    ...
    livekitLogger.debug("original[0] ".concat(original.height, "  ").concat(original.width, "  ").concat(original.encoding.maxBitrate, "  ").concat(original.encoding.maxFramerate));
    return encodingsFromPresets(width, height, [original]);
  }
  let presets = [];
  presets = (_a = sortPresets(options === null || options === void 0 ? void 0 : options.videoSimulcastLayers)) !== null && _a !== void 0 ? _a : defaultSimulcastLayers(isScreenShare, original);
